...
{
    /// <summary>
    /// Llegeix la configuració del log del gestor
    /// de fórmules des de la taula AT_MAT0943NET_CONFIG.
    /// </summary>
    public sealed class RepositoriConfiguracioLogGestorFormulesTarifes
    {
        ...
        public ConfiguracioLogGestorFormulesTarifes Carregar(
            string cadenaConnexio)
        {
            if (string.IsNullOrWhiteSpace(
                cadenaConnexio))
            {
                return new ConfiguracioLogGestorFormulesTarifes();
            }

            ConfiguracioLogGestorFormulesTarifes configuracio =
                new ConfiguracioLogGestorFormulesTarifes();
