...
{
    /// <summary>
    /// Log propi i independent del gestor de fórmules
    /// de tarifes.
    /// </summary>
    public static class GestorFormulesTarifesLogger
    {
        private const string PrefixFitxer =
            "GestorFormulesTarifes_";
            ...
            ConfiguracioLogGestorFormulesTarifes configuracio)
        {
            ...
            {
                Advertencia(
                    "No s'ha trobat configuració de log del gestor de fórmules. Es continua amb el log local de reserva.");
            ...
            {
                Advertencia(
                    "La configuració ha desactivat el log operatiu del gestor de fórmules.");
            ...
            {
                Advertencia(
                    "La configuració del log del gestor de fórmules no informa cap ruta. Es continua amb el log local de reserva.");
